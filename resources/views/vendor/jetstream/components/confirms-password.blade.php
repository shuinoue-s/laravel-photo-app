@props(['title' => __('messages.Confirm Password'), 'content' => __('messages.For your security, please confirm your password to continue.'), 'button' => __('messages.Confirm')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('messages.Password') }}"
